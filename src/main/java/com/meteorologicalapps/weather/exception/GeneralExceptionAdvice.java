package com.meteorologicalapps.weather.exception;
...
public class GeneralExceptionAdvice extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<String> handle(ConstraintViolationException exception) {
        return new ResponseEntity<>(exception.getMessage(), HttpStatus.BAD_REQUEST); //message will come from CityNameConstraint default message.
    }
